...
As Android Enterprise adoption continues to grow, an important question arises more and more frequently: _how does MTD work with the various Android Enterprise deployment scenarios?_
...
## [Fully managed](#work-managed-fully-managed) {#work-managed-fully-managed}

[![](/wp-content/uploads/2018/10/wm.png)](/wp-content/uploads/2018/10/wm.png)
...
## [COSU (dedicated device)](#cosu-dedicated-device) {#cosu-dedicated-device}

[![](/wp-content/uploads/2018/10/cosu2-1.png)](/wp-content/uploads/2018/10/cosu2.png)
...
## [Work profile (BYOD)](#work-profile-byod) {#work-profile-byod}

[![](/wp-content/uploads/2018/10/workprofile.png)](/wp-content/uploads/2018/10/workprofile.png)
...
## [Managed devices with work profiles (COPE, 8.0-10)](#managed-devices-with-work-profiles-cope) {#managed-devices-with-work-profiles-cope}

![](/wp-content/uploads/2018/10/wmwp.png)
...
## [Touching on VPN capabilities](#touching-on-vpn-capabilities) {#touching-on-vpn-capabilities}
...
The problem with this approach, though valid and arguably potentially _necessary_ for some traffic management capabilities prior to Android Pie (when APN configuration support was introduced), is as follows:

_Android supports one active VPN session at a time._
