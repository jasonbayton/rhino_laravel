...
### Corporate/personal data separation {#separation}
...
### Architecture component isolation {#isolation}
...
<div class="callout callout-info">
  ...
  Check out the <a href="/docs/enterprise-mobility/android/what-is-oemconfig/">linked article</a> to understand how OEMConfig will transform Android management.
</div>

## Android is flexible {#flexible}
...
### Provisioning methods {#provisioning}
...
## Android is simple to manage {#simple}
...
### System and application updates {#sys-app-updates}
...
## Android supports work/life balance {#downtime}
...
### Turning off the work profile {#bye-wp}
...
### Promoting privacy {#promoting-privacy}
...
_Are you a Windows Mobile/Phone customer/user still? Are you planning a move from the platform in light of its abandonment? Let me know in the comments, on_ [_LinkedIn_](https://linkedin.com/in/jasonbayton) _or_ [_@jasonbayton_](https://twitter.com/jasonbayton) _on Twitter._
